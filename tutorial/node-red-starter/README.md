# チュートリアル：Node-REDで始めるGameControllerizer ~IoTで世の中すべてをコントローラに！編
...
と入力してエンターキーを押してみましょう。あなたのRaspberry piのIPアドレスが192.168.0.4なら、  
http://192.168.0.4:1880/btn/hold/6  
です。
ゲームの中で、キャラクターが右に動くはずです！
